...
%     close all;
    ...
    G = roadmap(p560,sphereCenter,sphereCenter2,sphereCenter3,sphereRadius,n,k);
    
   
    P_pre=short_path(p560,qStart, xGoal, k, G,sphereCenter,sphereCenter2,sphereCenter3,sphereRadius,n);
